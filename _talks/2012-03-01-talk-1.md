...
where $\mathbf{U}_{i, j, k}$ denotes the volume-averaged conserved variables and $L_{\boldsymbol{U}}$ represents the general RHS evaluation for the fluid variables.